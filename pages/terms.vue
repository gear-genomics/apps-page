<template>
  <v-card max-width="900" class="mx-auto my-12 px-12 py-10" :elevation="2">
    ...
    <v-card-text>
      <h2>Terms of Use</h2>
      <p>
        The use and access of the GEAR website
        (<a href="https://www.gear-genomics.com" target="_blank" rel="noopener">www.gear-genomics.com</a>) and its associated
        Software (“the Site”) is subject to the following terms of use. Please read these terms carefully before accessing
        or using the Site.
      </p>
      ...
      <p>
        ...
        source code repository of GEAR (<a href="https://github.com/gear-genomics" target="_blank" rel="noopener">https://github.com/gear-genomics</a>).
      </p>
      ...
      <h2>Data protection Disclaimer</h2>
      <p>
      ...
      <h2>Medical information Disclaimer – Research purpose only</h2>
      <p>
        <strong>The Site is for research purpose only.</strong>
      ...
      <h2>Cookies and Privacy Disclaimer</h2>
      <p>
